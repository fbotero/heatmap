...
.config(['uiGmapGoogleMapApiProvider', function (GoogleMapApi) {
  ...
  .controller('ApproachAController30', ['$scope', 'uiGmapGoogleMapApi', function ($scope, GoogleMapApi) {
    ...
    $.ajax({
        ...
        // url: 'http://52.4.79.0:8095/HeatMapVsHeatCircle/rest/services/locations30',
