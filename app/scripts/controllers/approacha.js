...
.config(['uiGmapGoogleMapApiProvider', function (GoogleMapApi) {
  ...
  .controller('ApproachAController', ['$scope', 'uiGmapGoogleMapApi', '$route', function ($scope, GoogleMapApi, $route) {

    $scope.locations  = null;
    $scope.latitude_center = null;
    $scope.longitude_center = null;
    ...
    $.ajax({
        // url: 'http://localhost:8095/DistDemoTableauLogin/rest/services/locations',
        // url: 'http://52.4.79.0:8095/HeatMapVsHeatCircle/rest/services/locations',
        url: 'http://dashboards.bridgeenergygroup.com/HeatMapVsHeatCircle/rest/services/locations',
        dataType: 'json',
        isArray: true,
        data: null,
        async: false,
