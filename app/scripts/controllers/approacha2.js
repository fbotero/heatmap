...
.config(['uiGmapGoogleMapApiProvider', function (GoogleMapApi) {
  ...
  .controller('ApproachAController2', ['$scope', 'uiGmapGoogleMapApi', function ($scope, GoogleMapApi) {
    ...
    $.ajax({
        // url: 'http://localhost:8095/DistDemoTableauLogin/rest/services/locations2',
        // url: 'http://52.4.79.0:8095/HeatMapVsHeatCircle/rest/services/locations2',
        url: 'http://dashboards.bridgeenergygroup.com/HeatMapVsHeatCircle/rest/services/locations2',
        dataType: 'json',
        isArray: true,
        data: null,
        async: false,
